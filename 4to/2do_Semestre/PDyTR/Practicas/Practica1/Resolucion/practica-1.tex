...
Primero se responderan los puntos relacionados con todos los conceptos teóricos 
necesarios para la comprención de la práctica.\\
...
entre "socket cliente" y "socket servidor", planteado por la librería de java. Esto en se, no
sucede.
...
\subsection{Programas csock-javasock}
\subsubsection{csock}
\subsubsection{javasock}


\section{Comunicación mediante sockets\\Tipos}
...
\section{Servidores con y sin estado}
Una posible diferenciación de los servidores en el esquema cliente/servidor es la de 
servidor \textbf{con estado} y servidor \textbf{sin estado}

\subsection{Servidor con estado}
Un servidor con estado, es aquel que recuerda el estado en el que habia quedado el sistema
en la anterior conexión de un cliente.
