...
Como primera instancia, se definió nuestro archivo \texttt{.x}, disponible para ver en el apéndice \ref{punto-4}
...
Se ejecutó 50 veces el proceso cliente con los siguientes resultados: 
