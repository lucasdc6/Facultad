...
#define ADD 1
extern  enum clnt_stat add_1(operands *, int *, CLIENT *);
extern  bool_t add_1_svc(operands *, int *, struct svc_req *);
#define SUB 2
extern  enum clnt_stat sub_1(operands *, int *, CLIENT *);
extern  bool_t sub_1_svc(operands *, int *, struct svc_req *);
extern int simp_prog_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define ADD 1
extern  enum clnt_stat add_1();
